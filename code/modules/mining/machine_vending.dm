...
var/global/list/minevendor_list = list( //keep in order of price
	new /datum/data/mining_equipment("Food Ration",					/obj/item/weapon/reagent_containers/food/snacks/liquidfood,	-1,					20),
	new /datum/data/mining_equipment("Ore Scanner Pad",				/obj/item/weapon/ore_radar,									10,					50),
	new /datum/data/mining_equipment("Red Flags x5",				/obj/item/stack/flag/red,									10,					50),
	new /datum/data/mining_equipment("Green Flags x5",				/obj/item/stack/flag/green,									10,					50),
	new /datum/data/mining_equipment("Yellow Flags x5",				/obj/item/stack/flag/yellow,								10,					50),
	new /datum/data/mining_equipment("Purple Flags x5",				/obj/item/stack/flag/purple,								10,					50),
	...
	new /datum/data/mining_equipment("Rapid-Railway-Fabricator",	/obj/item/weapon/rrf,										10,					300),
	new /datum/data/mining_equipment("Magboots",					/obj/item/clothing/shoes/magboots,							10,					300),
	new /datum/data/mining_equipment("Kinetic Accelerator",			/obj/item/weapon/gun/energy/kinetic_accelerator,			10,					400),
	new /datum/data/mining_equipment("Miner's First-Aid Kit",		/obj/item/weapon/storage/firstaid/miner,					30,					400),
	...
	new /datum/data/mining_equipment("100 credits",					/obj/item/weapon/spacecash/c100,							-1,					500),
	...
	new /datum/data/mining_equipment("Industrial RIG",				/obj/item/weapon/rig/industrial,							5,					750),
	new /datum/data/mining_equipment("Wormhole Jaunter",			/obj/item/device/wormhole_jaunter,							20,					750),
	new /datum/data/mining_equipment("Mobile Ladder",				/obj/item/weapon/ladder_mobile,								5,					800),
	new /datum/data/mining_equipment("Hoist Kit",					/obj/item/hoist_kit,										5,					800),
